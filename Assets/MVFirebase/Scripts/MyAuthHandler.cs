...
{
    public class MyAuthHandler : MonoBehaviour
    {
        public TMP_InputField emailInputField;
        public TMP_InputField passwordInputField;
        public TextMeshProUGUI outputText;
        public string firestoreScene;
        ...
        private void Start()
        {
            ...
            FirebaseAuth.OnAuthStateChanged(gameObject.name, "LoadFirestore", "DisplayInfo");
        }
        ...
        {
            SceneManager.LoadScene(firestoreScene);
        }
    }
}